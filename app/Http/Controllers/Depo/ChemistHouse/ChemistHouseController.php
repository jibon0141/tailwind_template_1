...
class ChemistHouseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($chemistHouses)
                ...
                ->addColumn('mpo', fn($row) => $row->mpo->full_name ?? 'N/A')
                ...
                ->addColumn('action', function ($row) {
                    $editUrl = route('depo.chemist-house.edit', $row->id);
        ...
        return view('depo.extends.chemist_house.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        $mpos = Employee::where('employee_type','mpo')
            ...
            ->get();
        return view('depo.extends.chemist_house.create',compact('depo','mpos'));
    }
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            return view('depo.extends.chemist_house.edit', compact('chemistHouse','mpos'));
