...
namespace App\Http\Controllers\Depo\ChartOfAccount;
...
class ChartOfAccountController extends Controller
{
    public function index(Request $request){
        ...
        if($request->ajax()){
            ...
            return DataTables::of($chartOfAccounts)
                ...
                ->addColumn('action', function ($row) {
                    $editUrl = route('depo.chart-of-account.edit', $row->id);
                    $deleteUrl = route('depo.chart-of-account.delete', $row->id);
        ...
        return view('depo.extends.chart_of_account.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('depo.extends.chart_of_account.create', compact('glAccounts'));
    }
    ...
    public function edit($id)
    {
        ...
        $glAccounts = GlAccount::all();
        return view('depo.extends.chart_of_account.edit', compact('chartOfAccount', 'glAccounts'));
    }
        ...
        try {
            ...
            if (!$chartOfAccount) {
                return response()->json([
                    'success' => false,
                    'message' => 'Chart of Account not found or access denied'
                ], 404);
            }
            ...
            Log::info("Chart of Account Deleted Successfully for Id: {$id}");
            return response()->json([
                'success' => true,
            ...
            return response()->json([
                'success' => false,
                'message' => 'Chart of Account Delete Failed'
            ], 500);
        }
    }
}
