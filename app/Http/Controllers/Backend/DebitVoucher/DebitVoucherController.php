...
namespace App\Http\Controllers\Backend\DebitVoucher;
...
class DebitVoucherController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($query)
                ...
                ->addColumn('actions', function ($row) {
                    $editUrl = route('admin.debit-voucher.show', $row->id);
                    return '
        ...
        return view('admin.extends.debit_voucher.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            try {
                ...
                foreach ($request->chart_of_account_id as $index => $coaId) {
                    ...
                    $amount = $request->paid_amount[$index];

                    // Deduct running balance
                    ...
                    // Cash flow with correct running balance
                    CompanyCashFlow::create([
                        ...
                        'account_id'  => $request->account_id,
                        'voucher_route' => 'admin.debit-voucher.show',
        ...
        return view('admin.extends.debit_voucher.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.extends.debit_voucher.show', compact('debitVoucher'));
    }
  ...
  public function print($id)
    {
        ...
        return view('admin.print.debit_voucher', compact('debitVoucher'));
    }
