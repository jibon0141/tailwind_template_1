...
<div class="min-h-screen mb-5 bg-gray-100">
    <div class="max-w-7xl mx-auto px-4">
        ...
        {{-- Page Header --}}
        @include('employee.mpo.include.message')
        ...
        <div class="mt-8 bg-white p-6 rounded-lg shadow">
            <form action="{{ route('mpo.chemist-house.create') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text"
                               value="{{ $depo->depo_name ?? 'N/A' }}"
                               readonly
                               class="p-2 border border-gray-300 rounded bg-gray-100 text-gray-700 cursor-not-allowed">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text"
                               value="{{ $mpo->full_name ?? 'N/A' }} ({{$mpo->employee_code}})"
                               readonly
                               class="p-2 border border-gray-300 rounded bg-gray-100 text-gray-700 cursor-not-allowed">

                        {{-- Hidden ID --}}
                        <input type="hidden" name="mpo_id" value="{{ $mpo->user_id }}">
                    </div>
