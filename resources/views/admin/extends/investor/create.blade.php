                ...
                <form action="{{ route('admin.investor.create') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex flex-col md:col-span-2">
                            ...
                            <textarea name="bank_details" class="p-2 border border-gray-300 rounded focus:outline-none focus:border-teal-500" rows="2" required>{{ old('bank_details') }}</textarea>
                            @error('bank_details')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="flex flex-col md:col-span-2">
                            ...
                            <textarea name="address" class="p-2 border border-gray-300 rounded focus:outline-none focus:border-teal-500" rows="2" required>{{ old('address') }}</textarea>
                            @error('address')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="flex flex-col md:col-span-2">
                            ...
                            <textarea name="nominee_address" class="p-2 border border-gray-300 rounded focus:outline-none focus:border-teal-500" rows="2" >{{ old('nominee_address') }}</textarea>
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="nominee_nid" value="{{ old('nominee_nid') }}"
                                   class="p-2 border border-gray-300 rounded focus:outline-none focus:border-teal-500"
                        ...
                        <div class="flex flex-col md:col-span-2">
                            ...
                            <textarea name="nominee_bank_details" class="p-2 border border-gray-300 rounded focus:outline-none focus:border-teal-500" rows="2" >{{ old('nominee_bank_details') }}</textarea>
                            @error('nominee_bank_details')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                            @enderror
                        </div>
