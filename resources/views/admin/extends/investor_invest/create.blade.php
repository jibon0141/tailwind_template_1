...
<style>
    ...
    #investor_select + .select2-container .select2-selection__rendered {
        ...
        padding-right: 45px !important; /* space for arrow + clear */
        color: #111827;
    }
    ...
    /* Clear (×) button on right, before arrow */
    ...
    <div class="min-h-screen mb-5 bg-gray-100">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="mb-6 mt-2 pt-6 flex items-center justify-between">
                <h3 class="text-2xl font-bold text-gray-800">Create New Invest</h3>
            ...
            <div class="mt-8 bg-white p-6 rounded-lg shadow">
                <form action="{{ route('admin.investor.invest.create') }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {{-- Total Invest Amount --}}
                        <div class="flex flex-col">
                            <label class="mb-2 text-sm font-medium text-gray-600">Total Invest Amount</label>
                        ...
                        <div class="flex flex-col">
                            <label class="mb-2 text-sm font-medium text-gray-600">
                                Investing Amount <span class="text-red-500">*</span>
                            </label>
                            <input type="number" step="0.01" name="investing_amount"
                                   class="p-2 border border-gray-300 rounded focus:outline-none focus:border-teal-500"
                                   required>
                        </div>
    ...
    <script>
        $(document).ready(function () {
                    ...
                    processResults: function (data) {
                        return {
                            results: data.map(item => ({
                                id: item.id,
                                text: item.name,          // text is the name
            ...
            $('#investor_select').on('select2:select', function (e) {
                ...
                $('#investor_name').val(d.text); // <-- fixed: now passes the actual name
