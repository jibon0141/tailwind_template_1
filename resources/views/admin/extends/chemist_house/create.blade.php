    ...
    <div class="min-h-screen mb-5 bg-gray-100">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="mt-8 bg-white p-6 rounded-lg shadow">
                <form action="{{ route('chemist.house.create') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        ...
                        <div class="flex flex-col">
                            ...
                            <select name="depo_id" id="depo_id"
                                    class="p-2 border border-gray-300 rounded focus:outline-none focus:border-teal-500"
                                    required>
                                <option value="" disabled selected>Select Depo</option>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            depoSelect.addEventListener('change', function () {
                ...
                mpoSelect.innerHTML = '<option disabled selected>Loading...</option>';
                ...
                fetch("{{ route('chemist.house.getMpo') }}", {
                    ...
                    .then(res => res.json())
                    .then(res => {
                        mpoSelect.innerHTML = '<option disabled selected>Select MPO</option>';
                        ...
                        if (res.status && res.data.length > 0) {
                            ...
                            mpoSelect.innerHTML = '<option disabled selected>No MPO found</option>';
                        }
                    })
                    .catch(() => {
                        mpoSelect.innerHTML = '<option disabled selected>Error loading MPO</option>';
                    });
            });
