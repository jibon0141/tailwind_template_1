    ...
    <div class="min-h-screen bg-gray-100 p-6">
        ...
        <div class="mb-4 print:hidden flex justify-end">
            <a href="{{ route('admin.depo-due-collection.index') }}"
               class="inline-flex items-center px-4 py-2 bg-gray-600 text-white text-sm rounded hover:bg-gray-700">
                ← Back to Depo Due Collection List
            </a>
        </div>
        ...
        <div class="max-w-5xl mx-auto bg-white shadow rounded-lg p-6">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Depo Due Collection Voucher</h2>
                    ...
                    <tr>
                        ...
                        <td class="border px-3 py-2 text-right font-semibold">
                            @switch($depoDueCollection->payment_status)
                                @case(1)
                                    <span
                                        class="inline-block px-4 py-1 text-xs font-semibold text-green-800 bg-green-200 rounded-full">
                                        Paid
                                    </span>
                                    @break
                                ...
                                @case(2)
                                    <span
                                        class="inline-block px-4 py-1 text-xs font-semibold text-yellow-800 bg-yellow-200 rounded-full">
                                        Partial
                                    </span>
                                    @break
                                ...
                                @default
                                    <span
                                        class="inline-block px-4 py-1 text-xs font-semibold text-gray-800 bg-gray-200 rounded-full">
                                        Unpaid
                                    </span>
                            @endswitch
                        </td>
            ...
            <div class="mt-10 flex justify-between items-center text-sm text-gray-500">
                ...
                <a href="{{route('admin.depo-due-collection.print',$depoDueCollection->id)}}">
                    <button
