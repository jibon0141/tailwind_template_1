...
@section('content')
    <div class="page-wrapper bg-gray-100 min-h-screen p-6">
        ...
        <div class="bg-white p-6 rounded shadow mb-6 flex flex-col md:flex-row items-center justify-between">
            <h3 class="text-2xl font-semibold text-gray-800">Withdraw List</h3>

            <a href="{{ route('admin.investor.withdraw.create') }}"
    ...
    <script>
        $(document).ready(function () {
            var table = $('#investorInvestTable').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.investor.withdraw.index') }}",
                    data: function(d) {
                ...
                columns: [
                    ...
                    { data: 'withdraw_voucher', name: 'withdraw_voucher' },
