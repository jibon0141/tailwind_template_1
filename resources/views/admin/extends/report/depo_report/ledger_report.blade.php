...
@section("content")
    <div class="page-wrapper bg-white p-6 rounded shadow">
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-col md:flex-row md:justify-between items-center mb-6 gap-5">
                <h3 class="text-2xl font-semibold">Depo Ledger Report</h3>
