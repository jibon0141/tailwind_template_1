...
@section('content')
    <form method="POST" action="{{ route('admin.medicine.purchase.create') }}">
        @csrf
        <div class="min-h-screen bg-gray-100 p-4">
            <div class="mx-auto">
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('admin.medicine.purchase.index') }}" class="px-3 py-1.5 bg-indigo-600 text-white rounded text-sm">
                        📋 Purchase List
                    </a>
                </div>
                    ...
                    <div class="col-span-12 lg:col-span-9 bg-white rounded shadow p-3">
                        ...
                        <table class="w-full border text-sm">
                            ...
                            <tr>
                                ...
                                <th>Discount %</th>
                                <th>Unit Cost</th>
                                <th>Qty <span class="text-red-600">*</span></th>
                                <th>Free Qty</th>
                                <th>Expire Date <span class="text-red-600">*</span></th>
                                <th>Sub Total</th>
                                <th>Action</th>
                            </tr>
                            </thead>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#supplierSelect').select2({
                ...
                ajax: {
                    url: "{{ route('admin.medicine.purchase.getSuppliers') }}",
                    dataType: 'json',
                    delay: 250,
            ...
            // ================== Load Accounts ==================
            fetch("{{ route('admin.medicine.purchase.getPurchaseData') }}")
                .then(res => res.json())
                .then(data => {
            ...
            function medicineSearch(e, row) {
                ...
                fetch(`{{ route('admin.medicine.purchase.searchMedicine') }}?q=${encodeURIComponent(query)}`)
                    .then(r => r.json())
                    .then(data => {
