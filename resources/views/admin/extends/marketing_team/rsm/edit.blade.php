    ...
    <div class="min-h-screen bg-gray-100 p-6">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-6 mt-2 pt-6 flex items-center justify-between">
                <h3 class="text-2xl font-bold text-gray-800">Update RSM</h3>
            ...
            <form action="{{ route('rsm.update', $employee->id) }}" method="POST" class="bg-white p-6 rounded shadow">
                @csrf
                @method('PUT')
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" placeholder="Leave blank if not changing" class="w-full border p-2 rounded">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="parent_id" class="w-full border p-2 rounded">
                            ...
                            @foreach($nsms as $nsm)
                                <option value="{{ $nsm->id }}" {{ $employee->parent_id == $nsm->id ? 'selected' : '' }}>
                ...
                <div class="mt-6 text-right">
                    <button type="submit" class="bg-teal-500 hover:bg-teal-600 text-white px-6 py-2 rounded">Update RSM</button>
                </div>
