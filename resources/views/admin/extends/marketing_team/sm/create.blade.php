...
@section('content')
    <div class="min-h-screen bg-gray-100 p-6">
        <div class="max-w-7xl mx-auto">
            ...
            <form action="{{ route('sm.create') }}" method="POST" class="bg-white p-6 rounded shadow">
                @csrf
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" value="sm" class="w-full border p-2 rounded" readonly>
                    ...
                    <div>
                        ...
                        <select name="parent_id" class="border p-2 rounded w-full">
                            ...
                            @foreach($rsms as $rsm)
                                <option value="{{ $rsm->id }}" {{ old('parent_id') == $rsm->id ? 'selected' : '' }}>
