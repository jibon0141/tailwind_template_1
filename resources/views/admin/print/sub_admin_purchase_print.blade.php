...
<div class="min-h-screen bg-gray-100 p-2 md:p-6">
    ...
    <div id="invoice" class="max-w-5xl mx-auto bg-white shadow rounded-lg p-4 md:p-6">
        ...
        <!-- Footer -->
        <div class="mt-10 flex flex-wrap md:flex-nowrap justify-between items-center text-sm text-gray-500">
            ...
            <button onclick="window.print()"
                    class="px-4 py-2 bg-teal-600 text-white rounded hover:bg-teal-700 print:hidden flex-shrink-0">
                Print Invoice
            </button>
