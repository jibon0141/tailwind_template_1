...
<div class="min-h-screen p-2 md:p-6">
    ...
    <div id="voucher" class="max-w-5xl mx-auto bg-white shadow rounded-lg p-4 md:p-6">
        ...
        <div class="flex flex-col md:flex-row print:flex-row
            ...
            <p class="text-sm font-semibold text-gray-700">Distribute No : {{ $distribute->id ?? 'N/A' }}</p>
        ...
        <!-- Footer -->
        <!-- Footer -->
        <div class="mt-10 flex flex-col md:flex-row md:justify-between md:items-center gap-3 text-sm text-gray-500">

            <!-- Left: Generated on + Powered By (visible in print) -->
