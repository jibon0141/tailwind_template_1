...
<head>
    ...
    <title>Create Account | Tahsin Pharma</title>
...
<div class="register-card">
    ...
    <div class="text-center mb-7 animate-in">
        ...
        <p class="text-sm text-blue-200/60 mt-1">Register your shop</p>
    </div>
    ...
    <form action="{{ url('/shop/register') }}" method="POST" class="space-y-4" id="register-form">
        @csrf

        <div class="form-group animate-in animate-in-d1">
            <label class="block text-sm font-medium text-blue-100/70 mb-1.5" for="name">Full Name</label>
            <div class="relative">
        ...
        <div class="form-group animate-in animate-in-d3">
        ...
        <div class="form-group animate-in animate-in-d4">
            <label class="block text-sm font-medium text-blue-100/70 mb-1.5" for="password_confirmation">Confirm Password</label>
            <div class="relative">
                <i class="fa-solid fa-lock icon"></i>
        ...
        <div class="form-group animate-in animate-in-d5">
            <label class="block text-sm font-medium text-blue-100/70 mb-1.5" for="referral_code">EM Code <span class="text-white/30 font-normal">(optional)</span></label>
            <div class="relative">
        ...
        <button type="submit" class="btn-register animate-in animate-in-d6" id="register-btn">
            <div class="spinner"></div>
            <span class="btn-text"><i class="fa-solid fa-user-plus mr-2"></i>Register</span>
        </button>
    </form>

    <div class="flex items-center gap-3 my-6 animate-in animate-in-d6">
        <div class="flex-1 h-px bg-white/5"></div>
        <span class="text-white/30 text-xs whitespace-nowrap">Already have an account?</span>
        <div class="flex-1 h-px bg-white/5"></div>
    </div>

    <a href="{{ url('/shop/login') }}" class="login-link animate-in animate-in-d6">
        <i class="fa-solid fa-arrow-right-to-bracket mr-2 text-blue-400/70"></i>Sign In
    </a>

    <p class="text-center text-white/20 text-xs mt-8 animate-in animate-in-d6">
