    ...
    <div class="min-h-screen bg-gray-100 p-2 md:p-6">
        ...
        {{ $statusText }}
            ...
            <div class="mt-6 flex justify-between items-center gap-2 text-sm text-gray-500 print:hidden">
                ...
                <div class="">
                    <a href="{{ route('depo.direct-sale.print', $sale->id) }}">
                        <button class="px-4 py-2 bg-teal-700 text-white rounded hover:bg-teal-800 mr-2">
                            Print View
                        </button>
                    </a>

                    <a href="{{ route('depo.direct-sale.pos.print', $sale->id) }}">
