    ...
    <div class="min-h-screen bg-gray-100 p-2 md:p-6">
        ...
        <div id="voucher" class="max-w-5xl mx-auto bg-white shadow rounded-lg p-4 md:p-6">
            ...
            <div class="flex flex-col md:flex-row md:justify-evenly gap-2 text-center md:text-left mb-4">
                ...
                <p class="text-sm font-semibold">Purchase No : {{ $distribute->id ?? 'N/A' }}</p>
            ...
            <div class="mt-10 flex flex-col md:flex-row md:justify-between md:items-center gap-3 text-sm text-gray-500 print:hidden">
                ...
                <div class="flex gap-2">
                    <!-- Normal Print -->
                    <a href="{{ route('depo.pending-purchase.print', $distribute->id) }}">
                        <button
                    ...
                    <!-- POS Print -->
{{--                    <a href="{{ route('depo.pending-purchase.pos.print', $distribute->id) }}">--}}
{{--                        <button--}}
