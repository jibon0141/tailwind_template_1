    ...
    <div class="min-h-screen bg-gray-100 p-10">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-6 mt-2 pt-6 flex items-center justify-between">
                <h3 class="text-2xl font-bold text-gray-800">Create Credit Voucher</h3>
                <a href="{{ route('depo.credit-voucher.index') }}" class="inline-flex items-center gap-2 rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow hover:bg-blue-700 transition">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                <form action="{{ route('depo.credit-voucher.create') }}" method="POST" id="credit-voucher-form">
                    @csrf

                    {{-- MASTER DATA --}}
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 border-b pb-6 mb-6">
                        <div class="flex flex-col">
                            <label class="mb-2 font-semibold text-gray-700">Receive from (Party) <span class="text-red-500">*</span></label>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            const partyUrl   = "{{ route('depo.credit-voucher.get-parties') }}";
            const accountUrl = "{{ route('depo.credit-voucher.get-bank-accounts') }}";
            const coaUrl     = "{{ route('depo.credit-voucher.get-income-coa') }}";
