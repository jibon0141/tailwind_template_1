        ...
        <div class="content container mx-auto px-4 overflow-y-auto">
            ...
            <div class="mb-6">
                <div class="flex flex-col md:flex-row items-center justify-between mt-5">
                    ...
                    <!-- Create Button -->
                    <a href="{{ route('depo.credit-voucher.create') }}"
            ...
            <div class="bg-gray-100 p-4 rounded mb-6 grid grid-cols-1 md:grid-cols-6 gap-4">
                <input type="text" id="global_search" placeholder="Search Credit Vouchers..." class="border rounded p-2 w-full">
    ...
    <script>
        $(document).ready(function() {
            let table = $('#voucherTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route("depo.credit-voucher.index") }}',
                    data: function(d) {
