    ...
    <div class="min-h-screen bg-gray-100 p-10">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-6 mt-2 pt-6 flex items-center justify-between">
                ...
                <a href="{{ route('depo.debit-voucher.index') }}" class="inline-flex items-center gap-2 rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow hover:bg-blue-700 transition">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                <form action="{{ route('depo.debit-voucher.create') }}" method="POST" id="debit-voucher-form">
                    @csrf
...
@section('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            const partyUrl   = "{{ route('depo.debit-voucher.get-parties') }}";
            const accountUrl = "{{ route('depo.debit-voucher.get-bank-accounts') }}";
            const coaUrl     = "{{ route('depo.debit-voucher.get-expense-coa') }}";
