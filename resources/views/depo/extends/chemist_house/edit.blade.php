    ...
    <div class="min-h-screen mb-5 bg-gray-100">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="mt-8 bg-white p-6 rounded-lg shadow">
                <form action="{{ route('depo.chemist-house.update', $chemistHouse->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        ...
                        {{-- Depo (Fixed & Read-only) --}}
                        <div class="flex flex-col">
                            <label class="mb-2 text-sm font-medium text-gray-600">
                                Depo <span class="text-red-500">*</span>
                            </label>
                            <input type="text"
                                   value="{{ $chemistHouse->depo->depo_name ?? '' }}"
                                   class="p-2 border border-gray-300 rounded bg-gray-100 text-gray-700"
                                   readonly>
                            <input type="hidden" name="depo_id" value="{{ $chemistHouse->depo_id }}">
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <select name="mpo_id"
                                ...
                                @foreach($mpos as $mpo)
                                    <option value="{{ $mpo->user_id }}" {{ old('mpo_id', $chemistHouse->mpo_id) == $mpo->user_id ? 'selected' : '' }}>
